#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Convert kitti GT pose trajectory into tum file with valid timestamps. 

Taken from: https://github.com/MichaelGrupp/evo/blob/master/contrib/kitti_poses_and_timestamps_to_trajectory.py
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("timestamp_file", help="KITTI timestamp file of the poses")
    parser.add_argument(
