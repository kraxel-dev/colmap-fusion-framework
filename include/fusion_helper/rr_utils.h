...
// imaginary bounding box to fixate 3D Viewer in space (3d points beyond this box are not shown) # TODO: make generic to reconstruction
// coords
inline constexpr float XY_BOUND = 40.0f;  // [m] 3d points outside this bonund in xy are not shown in viewer
inline constexpr float Z_BOUND = 10.0f;   // [m] 3d points outside this bonund in z are not shown in viewer
...
/**
 * @brief Create 3D arrows that represent a pose in 3D space. Draw it ontop a rerun 3D transform instead of using the transforms own axis to
 * avoid the pesky autoscale of the tf axis when going back in time in the rr viewer.
 *
