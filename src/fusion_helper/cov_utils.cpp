...
fuhe::cov_utils::TimeScaledOdomCovManager::TimeScaledOdomCovManager(const OdomCovOptions& options) : options_(options) {
...
const Eigen::Matrix<double, 6, 6> fuhe::cov_utils::TimeScaledOdomCovManager::GetTimeDependantCovMat(const double time_diff) const {
...
const Eigen::Matrix<double, 6, 6> TimeScaledOdomCovManager::GetIdentityCovMat() const { return Eigen::Matrix<double, 6, 6>::Identity(); }
